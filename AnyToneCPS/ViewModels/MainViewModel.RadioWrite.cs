...
public partial class MainViewModel
{
    ...
    private async Task WriteChangesToRadioAsync()
    {
        ...
        // Put right in the confirmation dialog itself, not just the README,
        // since most users never see the README - this is the actual moment
        // a bad write could happen (a real one factory-reset a test radio
        // during development).
        summary = "Tip: back up first - Read From Radio and save the project (or export from the vendor CPS) - in case something goes wrong.\n\n" + summary;
